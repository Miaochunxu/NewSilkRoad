...
public abstract class McxBaseAdapterNoIf<T> extends BaseAdapter {

	@SuppressLint("UseSparseArrays")
	public McxBaseAdapterNoIf(Context context, int resid) {
	...
	public static void setIsSelected(List<Boolean> isSelected) {
		McxBaseAdapterNoIf.isSelected = isSelected;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view;
		// if (convertView == null) {
		view = LayoutInflater.from(getContext()).inflate(listCellId,
				null);
		// }
		initListCell(position, view, parent);
		return view;
	}
