...
public class ChineseTourGroupFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_chinese_group, container,
				false);
	...
	private void initView() {
		...
		listView = (ListView) view.findViewById(R.id.lv_fragment_chinese_group);
	...
	private void initCell() {
		...
		cell.add(new TourChineseAndForgien("", "新疆6日游", "自助式入住酒店，可选择跟团，纯玩",
				"1245"));
		cell.add(new TourChineseAndForgien("", "新疆6日游", "自助式入住酒店，可选择跟团，纯玩",
				"1245"));
		cell.add(new TourChineseAndForgien("", "新疆6日游", "自助式入住酒店，可选择跟团，纯玩",
