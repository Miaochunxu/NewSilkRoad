 ...
 * @Description: TODO 门票详情
 * @author 方硕IT 缪春旭
 * @date 2015-5-8 上午9:50:54
 * 
 */
public class TicketInfoActivity extends Activity {
	...
	private void updataContent() {
		...
		asyncImageLoader = new AsyncImageLoader(TicketInfoActivity.this);
		// String imageUrl01 =
		...
		LayoutInflater mInflater = LayoutInflater.from(TicketInfoActivity.this);
